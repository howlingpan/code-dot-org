...
titul: "Umělec: tvary" Náhled: page_curriculum téma: žádné

* * *

<%= partial('curriculum_header', :unittitle=>Kurz 1',: Lekce => 10,: titul => ' Umělec: tvary,: unplugged => false,: čas => 30) %>
...
Vrátíme-li se k umělci, hádanky v této fázi se zaměřují na kreslení, kombinování a dělení čtverců a obdélníků.
...
### **Aktivita: Umělecké tvary**

[Umělec: tvary](#Activity)
...
### Studenti budou:
  ...
  * Vytvořit program ke kreslení tvaru pomocí postupných kroků
  * Vysvětlete rozdíl mezi čtverci a obdélníky a podpořte to důkazy skládající se z povelů pro kreslení různých tvarů
  * Porovnat pozice různých objektů použitím "nahoře," "pod", "vedle"
  * Správně identifikovat tvary bez ohledu na jejich celkovou velikost
  * Porovnat a dát do protikladu čtverce a obdélníky podle jejich počtu stran a délky stran
...
Před zahájením této lekce, studenti by měli mít základní znalosti o čtvercích a obdélnících.

  * Jak si udělat čtverec? Obdélník?
  * Co se stane, když dáte dva čtverce vedle sebe?
...
### <a name="Activity"></a> [Umělec: tvary](http://learn.letron.vip/s/course1/stage/10/puzzle/1)
...
### Kopírka
  ...
  * Na jednom listu mají studenti nakreslete jednoduchý obrázek (pouze pravé úhly a rovné čáry)
...
### Obecné základní standardy matematiky
  ...
  * 1.G.A.3 - Rozdělení kruhů a obdélníků na dva a čtyři rovné tvary, popište pomocí slova polovina, čtvrtina a čtvrtiny a použijte věty se slovy polovina, čtvrtina a čtvrtletí. Popište celek jako ze dvou nebo čtyř částí. Pochopit tyto příklady, že rozkládají do stejných částí vytvářející menší části.
