...
titul: "Včelka: cykly" Náhled: page_curriculum téma: žádné
...
V poslední fázi studenti si zvyknou používat cykly pro opakování jednoduchých pohybů. Teď ať jdou doplnit opakování akcí s cílem pomoci včelám shromáždit více nektaru a udělat více medu.
...
### Studenti budou:
  ...
  * Napsat program pro daný úkol, který opakuje jediný povel
  * Určit kdy cyklus může posloužit pro zjednodušení opakujících akcí
  * Používat kombinaci sekvenčních a cyklických příkazů k přesunu a provedení akcí
...
### <a name="GetStarted"></a> Úvod
  ...
  * Denní aktivity co děláte, které lze popsat jako cyklus?
  * Pokud jste chtěli, aby vám někdo dal 5 sušenek, jak se na to zeptáte? 
      * Naléhejte na podrobný popis tohoto. Jak lze vzít jednu sušenku, pokud je uzavřená v krabičce? Jak lze dosáhnout na krabičku sušenek, když nejsem v kuchyni?
  * Je samozřejmě mnohem efektivnější dělat tuto činnost jako cyklus, místo pracně zadávat všechny instrukce pro získání 5 sušenek.
  * Jdeme pomoci včelce být efektivnější opakováním instrukcí, aby získala mnoho nektaru a mnoho medu.
...
### <a name="Activity"></a> [Včelka: Cykly](http://learn.letron.vip/s/course1/stage/14/puzzle/1)
