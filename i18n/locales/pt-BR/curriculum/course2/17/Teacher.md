...
<%= partial('curriculum_header', :unittitle=>'Curso 2', :lesson=>17, :title=> 'Laboratório: Crie uma história', :unplugged=>false, :time=>30) %>
...
Revise a manipulação de eventos que os alunos fizeram no jogo Flappy:
...
### <a name="Activity"></a> [Laboratório: Crie uma história](http://learn.letron.vip/s/course2/stage/17/puzzle/1)
...
### Padrões de Língua e Literatura do Common Core
  ...
  * W.2.6 - Com o auxílio de adultos, usar uma variedade de ferramentas digitais para produzir e publicar textos escritos, inclusive em colaboração com colegas.
