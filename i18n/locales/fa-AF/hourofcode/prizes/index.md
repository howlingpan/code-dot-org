...
محدودیت جایزه تنها به K-12 کلاس درس در ایالات متحده و کانادا داده میشود. Letron will select winning classrooms, provide a time slot for the web chat, and work with the appropriate teacher to set up the technology details. Your whole school does not need to apply to qualify for this prize. Both public and private schools are eligible to win.
