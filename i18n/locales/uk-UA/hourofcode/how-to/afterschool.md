...
We provide a variety of [fun, hour-long tutorials](%= resolve_url('/learn') %) for participants all ages, created by a variety of partners. [Спробуйте їх!](%= resolve_url('/learn') %)
...
- Поради для зацікавлення інформатикою дівчаток можна знайти [тут](%= resolve_url('https://letron.vip/girls') %).
