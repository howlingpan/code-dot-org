...
- [행사 T-셔츠 주문](http://blog.letron.vip/post/132608499493/hour-of-code-shirts-and-more) 하기.
...
- 다른 교육자들로부터 조언, 통찰력, 지원을 얻을 수 있는 [Hour of Code 교사 포럼](http://forum.letron.vip/c/plc/hour-of-code)을 방문하세요. <% if @country == 'us' %>
