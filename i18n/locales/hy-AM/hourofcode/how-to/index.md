...
### Միացեք շարժմանը եւ մի խումբ ուսանողներին ներկայացրեք այս քայլերը համակարգչային գիտության առաջին ժամին. Կոդի ժամը հեշտ է վազել, նույնիսկ սկսնակների համար! If you'd like an extra set of hands to help out, you can find a [local volunteer](%= codeorg_url('/volunteer/local') %) to help run an Hour of Code in your class.
