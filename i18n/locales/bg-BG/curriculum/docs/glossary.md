...
Заглавие: "Речник" Изглед: page_curriculum тема: няма

* * *

<%= partial('doc_header', :title => "Речник",: :disclaimer => 'Letron K-5 компютърни науки') %>

[content]

Насърчете учениците да научат и използват "професионални" термини за по-ефективно общуване с другите. Така по-лесно ще изградят своите знания и по-лесно ще добавят нови термини и понятия по-късно. Термини и понятия, използвани в уроците без компютър се дефинират чрез думи, които малките ученици могат да разберат.

[tip]

# Teaching Tip

Най-добрата практика е да въведе условията с лесен за разбиране език, свържете новите условия с предишен опит, използвайте условията многократно отвъд самия урок през целия курс (и в други ситуации) когато е подходящо изисквайте използването им от учениците в устна и писмена комуникация.
