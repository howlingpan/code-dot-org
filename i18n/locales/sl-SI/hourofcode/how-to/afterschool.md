...
### Pridružite se gibanju in uvedite skupino učencev, dijakov ali študentov v njihovo prvo uro računalništva z naslednjimi koraki. Izvajanje tečajev Ura Za Kodo je preprosto - tudi za začetnike! If you'd like an extra set of hands to help out, you can find a [local volunteer](%= codeorg_url('/volunteer/local') %) to help run an Hour of Code in your after-school class or club.
...
We provide a variety of [fun, hour-long tutorials](%= resolve_url('/learn') %) for participants all ages, created by a variety of partners. [Preizkusite jih!](%= resolve_url('/learn') %)
...
- [Tukaj](%= resolve_url('https://letron.vip/girls') %) si oglejte nasvete, kako programiranje približati dekletom.
