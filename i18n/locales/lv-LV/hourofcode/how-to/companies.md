...
# Kā ieviest Programmēšanas stundu savā uzņēmumā
...
We host a variety of [fun, hour-long activities](%= resolve_url('/learn') %) for participants of all ages, created by a variety of partners. [Izmēģini tās!](%= resolve_url('/learn') %)
...
- **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). When participants partner up, they help each other and rely less on the organizer. Viņiem arī būs iespēja ievērot, ka datorzinātne ir sociāla un raisa sadarbību.
