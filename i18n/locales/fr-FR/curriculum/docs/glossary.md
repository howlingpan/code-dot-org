...
Une série d'étapes à suivre pour compléter une tâche. Une suite d'instructions qui peuvent être effectuées avec ou sans ordinateur. Par exemple, la collection d'étapes pour préparer un sandwich au beurre d'arachide est un algorithme.

*(Cours 1 : Leçons 1, 6 | Cours 2 : Leçons 1, 2 | Cours 3 : Leçons 1, 10)*

#### binaire

Une manière de représenter des informations à l'aide de seulement deux options.
...
Une erreur dans un programme qui l'empêche de s'exécuter comme prévu. *(Cours 2 : Leçon 9)*

#### code

Les commandes ou les algorithmes conçus pour être exécutés par un ordinateur. Voir Programme. *(Cours 1 : Leçon 2)*
