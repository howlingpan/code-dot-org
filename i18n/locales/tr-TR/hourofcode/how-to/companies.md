...
Letron, çalışanlarınıza, Kod-Saati çalışan yerel sınıflara [bağlanma](%= codeorg_url('/volunteer') %) ve burada teknik deneyimlerini paylaşma ve öğrencilere bilgisayar öğrenmeleri için ilham olma fırsatı sunar.
