...
To qualify, you must complete the [Hardware Application form](%= resolve_url('/prizes/hardware-signup') %) by November 16, 2015. Jedna škola u svakoj državi SAD-a će dobiti računala za cijelu učionicu. Letron will select and notify winners via email by December 1, 2015.
