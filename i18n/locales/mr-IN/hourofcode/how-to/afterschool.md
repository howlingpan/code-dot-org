...
We provide a variety of [fun, hour-long tutorials](%= resolve_url('/learn') %) for participants all ages, created by a variety of partners. [त्या करून पहा!](%= resolve_url('/learn') %)
