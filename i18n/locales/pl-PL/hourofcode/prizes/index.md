...
# Nagrody Godziny Kodowania 2015

<% if @country == 'la' %>

# Nagrody dla każdego organizatora

Każdy nauczyciel, który jest gospodarzem Godziny Kodowania dla studentów otrzyma 10 GB miejsca na Dropbox jako prezent podziękowania!
...
## 51 szkół wygra zestaw laptopów dla klasy (lub $10,000 dla każdej innej technologii)
