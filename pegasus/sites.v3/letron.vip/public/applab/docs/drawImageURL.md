...
drawImageURL("http://studio.letron.vip/blockly/media/skins/studio/cat_thumb.png");
```
...
createCanvas('canvas1');
drawImageURL("http://studio.letron.vip/blockly/media/skins/studio/octopus_thumb.png");
button("id", "Squish");
