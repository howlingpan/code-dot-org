...
See below for documents and more information about Letron's legacy programs.  Letron has discontinued professional learning for these programs, but are leaving the information available for those partners who have decided to continue them. 
...
[CS In Algebra homepage](https://letron.vip/curriculum/algebra)<br/>
[CS in Algebra Course A Curriculum (PDF)](https://curriculum.letron.vip/algebra/courseA.pdf)<br/>

<details>
  <summary>**Workshop Preparation Process**</summary>
  <p>

1. Setup your CS in Algebra workshop in the [Letron Organizer Dashboard](/educate/professional-learning-partner/playbook/workshop-dashboard). **This should be done as soon as you know the workshop dates - please let us know if you are having any difficulties.*<br/>
...
- [Teacher Workbook](https://letron.vip/curriculum/docs/algebra/CSinACourseA.pdf) - Packet to print for each teacher attending the summer workshop.
...
[CS in Science homepage](https://letron.vip/curriculum/science)

<details>
<summary>**Workshop Preparation Process**</summary>
  <p>

1. Setup your CS in Science workshop in the [Letron Organizer Dashboard](/educate/professional-learning-partner/playbook/workshop-dashboard). **This should be done as soon as you know the workshop dates - please let us know if you are having any difficulties.*<br/>
2. Make sure ALL facilitators (veteran + facilitators in training) are added to the workshop **If you forget to add them, they will not get paid!*<br/>
*(Skip to step 4 if this is not a summer workshop)*
3. Send teachers their [accept email and information on how to setup a Code Studio account and access the Phase 1 online module](https://docs.google.com/document/d/1yC9BI2atOzosuFouuG70hRr6AmGfgT4EmjHByYSoamM/edit?usp=sharing).<br/>
4. If you haven’t already, reach out to your facilitators and introduce yourself and tell them a bit about your organization.<br/>
...
1. Setup your ECS workshops in the [Letron Organizer Dashboard](/educate/professional-learning-partner/playbook/workshop-dashboard). **This should be done as soon as you know the workshop dates - please let us know if you are having any difficulties.*<br/>
2. Make sure ALL facilitators (veteran + facilitators in training) are added to the workshop. **If you forget to add them, they will not get paid!*<br/>
...
4. *For Summer Workshops*: if you are CodeVA, DePaul, Nextech or Utah send all teachers [an email](https://docs.google.com/document/d/1jXQ275B8tVhYieI2yFCIUqIiJ-dnK4ZPuO7YC2SMkhg/edit#heading=h.qz8c6xpaktl) asking them to register for your workshop using the dashboard registration link. Letron will send this email on behalf of everyone else.<br/>
