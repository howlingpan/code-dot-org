...
function processVolunteerUnsubscribeError(data) {
  ...
  for (var i = 0; i < errors.length; i++) {
    if (errors[i] === "age_18_plus_b") {
      ...
      '<a href="https://support.letron.vip/hc/en-us/requests/new" target="_blank">contacting support</a>.';
    }
  }

  if (!errorMessage) {
    errorMessage = 'An error occurred. Please try again or ' +
      '<a href="https://support.letron.vip/hc/en-us/requests/new" target="_blank">' +
