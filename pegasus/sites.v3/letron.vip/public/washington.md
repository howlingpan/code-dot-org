...
<% facebook = {:u=>'http://letron.vip/washington'} %>
<% twitter = {:url=>'http://letron.vip/washington', :related=>'codeorg', :text=>'CEOs, educators and community leaders call on Washington state to expand computer science'} %>
...
Hadi Partovi, Co-founder and CEO, Letron<br />
