...
### ఉద్యమంలో చేరండి మరియు ఈ దశలను కంప్యూటర్ సైన్స్ వారి మొదటి గంటకు విద్యార్థుల బృందాన్ని పరిచయం చేయండి. Hour of Code సులభంగా నడిపించవచ్చు- మొదటి సారి ఉపయోముగించే వాళ్లకు కూడా! If you'd like an extra set of hands to help out, you can find a [local volunteer](<%= codeorg_url('/volunteer/local') %>) to help run an Hour of Code in your after-school class or club.
