...
We host a variety of [fun, hour-long activities](<%= resolve_url('/learn') %>) for participants of all ages, created by a variety of partners. [נסו אותם!](<%= resolve_url('/learn') %>)
...
## 5. התחל את שעה של הקוד שלך עם סרט מעורר השראה
