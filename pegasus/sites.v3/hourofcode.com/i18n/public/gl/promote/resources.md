...
1. Calquera referencia á marca "Hour of Code" debe ser feita de forma que non suxira que é unha marca da súa propiedade, senón unha referencia á Hora do Código como un movemento popular. **Good example**: "Participate in the Hour of Code™ at ACMECorp.com." **Bad example**: "Try Hour of Code by ACME Corp."
...
Computers are everywhere, changing every industry on the planet, but fewer than half of all schools teach computer science. Girls and minorities are severely underrepresented in computer science classes, and in the tech industry. A boa noticia é que estamos en camiño de mudar esta realidade.
