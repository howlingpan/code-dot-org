...
We host a variety of [fun, hour-long activities](<%= resolve_url('/learn') %>) for participants of all ages, created by a variety of partners. [Probeer ze uit](<%= resolve_url('/learn') %>)
...
De beste CodeUur ervaring beleef je met computers die met internet verbonden zijn. But you **don’t** need a computer for every participant, and you can even do the Hour of Code without a computer at all.
