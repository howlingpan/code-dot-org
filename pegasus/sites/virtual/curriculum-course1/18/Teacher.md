...
<%= partial('curriculum_header', :unittitle=>'Course 1', :lesson=>18, :title=> 'Artist: Loops', :unplugged=>false, :time=>30) %>
...
## Activity
### <a name="Activity"></a> [Artist: Loops](http://learn.letron.vip/s/course1/stage/18/puzzle/1)
