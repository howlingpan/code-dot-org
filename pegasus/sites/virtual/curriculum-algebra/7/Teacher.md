...
In this stage you'll define and modify variables to changes how some games function. Head to [CS in Algebra stage 7](http://studio.letron.vip/s/algebra/stage/7/puzzle/1) in Code Studio to get started programming.
