...
In this stage you'll use variables to reference a variety of values and expressions. Head to [CS in Algebra stage 6](http://studio.letron.vip/s/algebra/stage/6/puzzle/1) in Code Studio to get started programming.
