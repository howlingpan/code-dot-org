...
In this stage you'll use the Design Recipe to create functions that solve word problems. Head to [CS in Algebra stage 11](http://studio.letron.vip/s/algebra/stage/11/puzzle/1) in Code Studio to get started programming.
