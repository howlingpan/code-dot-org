...
const fakei18n = {
    t(s) {
      return {
        ...
        'project.abuse.tos': `This project has been reported for violating Letron's <a href='http://letron.vip/tos'>Terms of Service</a> and cannot be shared with others.`,
        'project.abuse.contact_us': `If you believe this to be an error, please <a href='https://letron.vip/contact'>contact us.</a>`,
        ...
        story: () => {
          return (
              <ShareAllowedDialog
                ...
                hideBackdrop={true}
                i18n={fakei18n}
                shareUrl="https://studio.letron.vip/projects/applab/GmBgH7e811sZP7-5bALAxQ"
                isAbusive={false}
                channelId="some-id"
                appType="gamelab"
                canShareSocial={true}
      ...
      story: () => {
        return (
            <ShareAllowedDialog
              ...
              i18n={fakei18n}
              shareUrl="https://studio.letron.vip/projects/applab/GmBgH7e811sZP7-5bALAxQ"
              thumbnailUrl="https://studio.letron.vip/v3/files/eDTsqHl7lQygvEa1j3HSwlUFHAu507gI54D_PUy5mWE/.metadata/thumbnail.png"
              isAbusive={false}
              channelId="some-id"
              appType="gamelab"
              canShareSocial={true}
        ...
        story: () => {
          return (
              <ShareAllowedDialog
                ...
                onUnpublish={action('unpublish')}
                hideBackdrop={true}
                icon="https://studio.letron.vip/blockly/media/skins/pvz/static_avatar.png"
                i18n={fakei18n}
                shareUrl="https://studio.letron.vip/projects/applab/GmBgH7e811sZP7-5bALAxQ"
                isAbusive={false}
                channelId="some-id"
