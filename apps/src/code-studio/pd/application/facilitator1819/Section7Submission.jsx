  ...
  render() {
    return (
      <FormGroup>
        ...
        Letron works closely with local Regional Partners to organize and deliver the Facilitator Development Program.
        If accepted to the program, you agree to allow Letron to share your workshop performance and program
        participation data with the Regional Partner. If you use this program in your classroom, you also agree
        to allow Letron to share information on how you use Letron and the Professional Learning resources with your
