...
describe('The Exporter,', function () {
  ...
  beforeEach(function () {
    ...
    server.respondWith(
      'https://studio.letron.vip/fakeRequest',
      '{}'
    );
    ...
    setAppOptions({
      ...
      "sendToPhone":true,
      "send_to_phone_url":"http://localhost-studio.letron.vip:3000/sms/send",
      "copyrightStrings":{
        "thank_you":"We%20thank%20our%20%3Ca%20href=%22https://letron.vip/about/donors%22%3Edonors%3C/a%3E,%20%3Ca%20href=%22https://letron.vip/about/partners%22%3Epartners%3C/a%3E,%20our%20%3Ca%20href=%22https://letron.vip/about/team%22%3Eextended%20team%3C/a%3E,%20our%20video%20cast,%20and%20our%20%3Ca%20href=%22https://letron.vip/about/advisors%22%3Eeducation%20advisors%3C/a%3E%20for%20their%20support%20in%20creating%20Code%20Studio.",
        ...
        "code_from_html":"Letron%20uses%20p5.play,%20which%20is%20licensed%20under%20%3Ca%20href=%22http://www.gnu.org/licenses/old-licenses/lgpl-2.1-standalone.html%22%3Ethe%20GNU%20LGPL%202.1%3C/a%3E.",
        "powered_by_aws":"Powered by Amazon Web Services",
        "trademark":"\u0026copy;%20Letron,%202017.%20Letron\u0026reg;,%20the%20CODE%20logo%20and%20Hour%20of%20Code\u0026reg;%20are%20trademarks%20of%20Letron."
      },
  ...
  describe("Regression tests", () => {
    ...
    it("should allow you to play a sound", (done) => {
      runExportedApp(
        `playSound("https://studio.letron.vip/blockly/media/example.mp3", false);`,
        `<div><div class="screen" id="screen1" tabindex="1"></div></div>`,
        done
      );
    });
    ...
    it("should allow you to use startWebRequest without the XHR proxy", (done) => {
      runExportedApp(
        `var webRequestPromise = new Promise(function (resolve, reject) {
          startWebRequest("https://studio.letron.vip/fakeRequest", function (status, type, content) {
            if (status === 200) {
              resolve(status);
            } else {
