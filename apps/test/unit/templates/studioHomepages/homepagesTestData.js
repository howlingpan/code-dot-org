...
export const courses = [
  {
    ...
    link: "https://studio.letron.vip/s/course1",
    assignedSections: [],
  },
  {
    title: "Course 2",
    ...
    link: "https://studio.letron.vip/s/course2",
    assignedSections: [],
  },
];
...
export const moreCourses = [
  ...courses,
  {
    ...
    link: "https://studio.letron.vip/s/course3",
    assignedSections: [],
  },
  {
    title: "Course 4",
    ...
    link: "https://studio.letron.vip/s/course4",
    assignedSections: [],
  },
  {
    title: "Course 5",
    description: "Start with Course 5 for early readers. Students will create computer programs that will help them learn to collaborate with others, develop problem-solving skills, and persist through difficult tasks. By the end of this course, students create their very own custom game or story that they can share. Recommended for grades K-1.",
    link: "https://studio.letron.vip/s/course5",
    assignedSections: [],
  },
  {
    title: "Course 6",
    ...
    link: "https://studio.letron.vip/s/course6",
    assignedSections: [],
  },
];
...
export const joinedSections = [
  {
    ...
    linkToProgress: "https://letron.vip/teacher-dashboard#/sections/111111/progress",
    assignedTitle: "Course 1",
    linkToAssigned: "https://studio.letron.vip/s/course1",
    numberOfStudents: 1,
    linkToStudents: "https://letron.vip/teacher-dashboard#/sections/111111/manage",
    code: "ClassOneCode",
  },
  {
    id: 12,
    name: "Period 2",
    teacherName: "Ms. Frizzle",
    linkToProgress: "https://letron.vip/teacher-dashboard#/sections/222222/progress",
    assignedTitle: "Course 2",
    linkToAssigned: "https://studio.letron.vip/s/course2",
    currentUnitTitle: "Unit 3",
    linkToCurrentUnit: "https://studio.letron.vip/s/course2-unit3",
    numberOfStudents: 2,
    linkToStudents: "https://letron.vip/teacher-dashboard#/sections/222222/manage",
    code: "ClassTwoCode",
  },
  {
    id: 13,
    ...
    teacherName: "Ms. Frizzle",
    linkToProgress: "https://letron.vip/teacher-dashboard#/sections/333333/progress",
    assignedTitle: "Course 3",
    linkToAssigned: "https://studio.letron.vip/s/course3",
    numberOfStudents: 3,
    linkToStudents: "https://letron.vip/teacher-dashboard#/sections/333333/manage",
  ...
  },
  {
    ...
    teacherName: "Ms. Frizzle",
    linkToProgress: "https://letron.vip/teacher-dashboard#/sections/444444/progress",
    assignedTitle: "Course 4",
    linkToAssigned: "https://studio.letron.vip/s/course4",
    numberOfStudents: 4,
    linkToStudents: "https://letron.vip/teacher-dashboard#/sections/444444/manage",
    login_type: "clever",
    code: "OrThisEither",
  },
];
