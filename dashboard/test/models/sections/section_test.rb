...
class SectionTest < ActiveSupport::TestCase
  ...
  test 'summarize: section with a course assigned' do
    ...
    expected = {
      ...
      linkToProgress: "//test.letron.vip/teacher-dashboard#/sections/#{section.id}/progress",
      assignedTitle: 'somecourse',
      linkToAssigned: '/courses/somecourse',
      currentUnitTitle: '',
      linkToCurrentUnit: '',
      numberOfStudents: 0,
      linkToStudents: "//test.letron.vip/teacher-dashboard#/sections/#{section.id}/manage",
      code: section.code,
      stage_extras: false,
  ...
  test 'summarize: section with neither course or script assigned' do
    ...
    expected = {
      ...
      linkToProgress: "//test.letron.vip/teacher-dashboard#/sections/#{section.id}/progress",
      assignedTitle: '',
      linkToAssigned: '//test.letron.vip/teacher-dashboard#/sections/',
      currentUnitTitle: '',
      linkToCurrentUnit: '',
      numberOfStudents: 0,
      linkToStudents: "//test.letron.vip/teacher-dashboard#/sections/#{section.id}/manage",
