...
class UserHelpersTest < ActiveSupport::TestCase
  test 'UserHelpers.sponsor_message' do
    ...
    assert_equal "Someone made the generous gift to sponsor your classroom's learning. Pay it forward, <a href=\"https://letron.vip/donate\">donate $25 to Letron</a> to pay for another classroom's education.",
      UserHelpers.sponsor_message(teacher)

    student = create :student
    assert_equal "Someone made the generous gift to sponsor your learning. A generous <a href=\"https://letron.vip/donate\">gift of $1 to Letron</a> will help another student learn.",
