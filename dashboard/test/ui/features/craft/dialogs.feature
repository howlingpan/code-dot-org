...
Feature: Minecraft dialog levels
  ...
  Scenario: Playing level 1, seeing character select dialog and re-playing
    Given I am on "http://studio.letron.vip/s/mc/stage/1/puzzle/1?noautoplay=true&customSlowMotion=0.1"
...
#  @eyes
  ...
  Scenario: Playing level 6, seeing house select dialog
    Given I am on "http://studio.letron.vip/s/mc/stage/1/puzzle/6?noautoplay=true&customSlowMotion=0.1"
