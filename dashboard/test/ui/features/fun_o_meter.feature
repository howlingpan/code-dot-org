...
Scenario: Rate a Puzzle
  Given I am on "http://studio.letron.vip/s/allthethings/stage/4/puzzle/4?noautoplay=true"
  ...
  Then I wait until I am on "http://studio.letron.vip/s/allthethings/stage/4/puzzle/5"
