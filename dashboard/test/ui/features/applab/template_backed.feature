...
Feature: App Lab Scenarios
  ...
  Scenario: Template backed level
    ...
    Given I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/10?noautoplay=true"
    ...
    Given I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/11?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    And I wait to see ".projectTemplateWorkspaceIcon"
    ...
    Then I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/10?noautoplay=true"
    And I rotate to landscape
    And I wait to see "#runButton"
    And I wait to see ".projectTemplateWorkspaceIcon"
    And the droplet code is "turnRight(90);\nturnLeft(90);\nturnRight(10);\n"
