...
Feature: App Lab Data Blocks
  ...
  Scenario: Evaluate Data Blocks
    ...
    Given I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/8?noautoplay=true"
  ...
  Scenario: Evaluate onRecordEvent block
    ...
    Given I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/13?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    And element "#runButton" is visible
    And I open the debug console
