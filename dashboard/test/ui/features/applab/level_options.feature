...
Scenario: Table data in level definition appears in data browser
  Given I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/16"
...
Scenario: Level defaults to design mode, students see design mode and teachers see code mode when viewing student work
  ...
  And I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/21"
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/18/puzzle/21"
