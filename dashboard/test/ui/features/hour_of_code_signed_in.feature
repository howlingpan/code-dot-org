...
Scenario:
  ...
  Then I wait until I am on "http://studio.letron.vip/hoc/2"
  And I wait for the page to fully load
...
Scenario: Failing at puzzle 6, refreshing puzzle 6, bubble should show up as attempted
  Given I am on "http://studio.letron.vip/hoc/6?noautoplay=true"
...
Scenario: Async progress write followed by a stale read
  Given I am on "http://studio.letron.vip/hoc/20?noautoplay=true"
  And I wait for the page to fully load
...
Scenario: Progress on the server that is not on the client
  ...
  And I press "runButton"
  Then I am on "http://studio.letron.vip/hoc/reset"
  Then I am on "http://studio.letron.vip/hoc/20?noautoplay=true"
