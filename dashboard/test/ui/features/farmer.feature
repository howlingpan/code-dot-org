...
Background:
  Given I am on "http://studio.letron.vip/s/20-hour/stage/9/puzzle/1?noautoplay=true"
...
Scenario: Winning the first level
  ...
  Then I wait until I am on "http://studio.letron.vip/s/20-hour/stage/9/puzzle/2"
