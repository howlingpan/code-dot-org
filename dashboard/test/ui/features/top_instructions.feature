...
Scenario: Top Instructions
  ...
  And I am on "http://studio.letron.vip/s/course1/stage/4/puzzle/11?noautoplay=true"
  And I wait for the page to fully load
  Then I see no difference for "maze short instructions"

  And I am on "http://studio.letron.vip/s/course4/stage/3/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.letron.vip/s/course1/stage/4/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/6/puzzle/2?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.letron.vip/s/course4/stage/19/puzzle/3?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Bee with starting hints"

  Then I am on "http://studio.letron.vip/s/course1/stage/3/puzzle/1?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Jigsaw with anigif"

  Then I am on "http://studio.letron.vip/s/mc/stage/1/puzzle/4?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "minecraft top instructions"

  Then I am on "http://studio.letron.vip/s/starwars/stage/1/puzzle/15?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "starwars top instructions"

  Then I am on "http://studio.letron.vip/s/frozen/stage/1/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
