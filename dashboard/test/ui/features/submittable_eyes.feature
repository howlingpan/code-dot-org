...
Scenario: Submittable level
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/9/puzzle/3?noautoplay=true"
...
Scenario: Lockable level
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/lockable/1/puzzle/1/page/1"
  And I wait to see ".submitButton"
