...
Background:
  Given I am on "http://studio.letron.vip/s/playlab/stage/1/puzzle/10?noautoplay=true"
...
Scenario: Sharing an email studio game
  Given I am on "http://studio.letron.vip/s/playlab/stage/1/puzzle/10?noautoplay=true"
  And I wait for the page to fully load
  And I've initialized the workspace with a studio say block saying "brian@letron.vip"
  Then I press "runButton"
  Then I press ".share" using jQuery
  Then I wait to see "#share-fail-explanation"
