...
Background:
  Given I am on "http://studio.letron.vip/hoc/reset"

Scenario: Solving puzzle 1, proceeding to puzzle 2, verifying that puzzle 1 appears as solved
  Given I am on "http://studio.letron.vip/hoc/1?noautoplay=true"
  ...
  And I wait until I am on "http://studio.letron.vip/hoc/2"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.letron.vip/s/20-hour/stage/2/puzzle/2?noautoplay=true"
  Then I wait until I am on "http://studio.letron.vip/s/20-hour/stage/2/puzzle/2?noautoplay=true"
  And I verify progress in the header of the current page is "not_tried" for level 1
  # Level source is saved
  Then I am on "http://studio.letron.vip/hoc/1?noautoplay=true"
  Then I wait until I am on "http://studio.letron.vip/hoc/1?noautoplay=true"
  And I wait for the page to fully load
  And block "6" is child of block "5"
  # Level source is reset
  Then I am on "http://studio.letron.vip/hoc/reset"
  Then I am on "http://studio.letron.vip/hoc/1?noautoplay=true"
  Then I wait until I am on "http://studio.letron.vip/hoc/1?noautoplay=true"
  And I wait for the page to fully load
...
Scenario: Go to puzzle 10, see video, go somewhere else, return to puzzle 10, should not see video, comes back on link
  Given I am on "http://studio.letron.vip/hoc/10"
  And I rotate to landscape
  Then I wait until element ".video-modal" is visible
  Then I close the dialog
  Then I am on "http://studio.letron.vip/hoc/11"
  Then I wait until I am on "http://studio.letron.vip/hoc/11"
  And I wait for the page to fully load
  Then I am on "http://studio.letron.vip/hoc/10"
  Then I wait until I am on "http://studio.letron.vip/hoc/10"
  And I wait for the page to fully load
...
Scenario: Go to puzzle 9, see callouts, go somewhere else, return to puzzle 9, should not see callouts
  Given I am on "http://studio.letron.vip/hoc/9?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element ".qtip-content:contains('Blocks that are grey')" is visible
  Then I am on "http://studio.letron.vip/hoc/10?noautoplay=true"
  Then I wait until I am on "http://studio.letron.vip/hoc/10?noautoplay=true"
  And I wait for the page to fully load
  Then I am on "http://studio.letron.vip/hoc/9?noautoplay=true"
  Then I wait until I am on "http://studio.letron.vip/hoc/9?noautoplay=true"
  And I wait for the page to fully load
