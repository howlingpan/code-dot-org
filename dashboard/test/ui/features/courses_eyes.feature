...
Scenario: Signed out courses, learn
  ...
  Then I am on "http://studio.letron.vip/courses"
...
Scenario: Signed out courses, teach
  ...
  Then I am on "http://studio.letron.vip/courses?view=teacher"
...
Scenario: Signed out courses, non-english
  ...
  Given I am on "http://studio.letron.vip/home/lang/es"
  Then I wait until I am on "http://studio.letron.vip/users/sign_in"
  And I wait to see ".headerlinks"
