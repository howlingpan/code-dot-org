...
Feature: Swapped levels
  Scenario: Signed-out user sees active version
    When I am on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/1"
    Then I wait until element ".instructions-markdown" contains text "Guide me to the green evilness!"
    When I am on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/4"
    Then I wait until element ".standalone-video>h1" contains text "Video: Artist Intro"
    When I am on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/5"
  ...
  Scenario: Student with progress sees old version
    Given I complete the level on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/1?level_name=2-3 Maze 1"
    And I complete the level on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/4?level_name=2-3 Artist 1 new"
    And I am on "http://studio.letron.vip/s/allthethings/stage/29/puzzle/5?level_name=ramp_video_loopsArtist&noautoplay=true"
