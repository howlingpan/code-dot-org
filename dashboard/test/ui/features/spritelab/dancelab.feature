...
Feature: Dance Lab
  ...
  Scenario: Restricted audio content is protected
    When I am on "http://studio.letron.vip/restricted/placeholder.txt"
    Then page text does not contain "placeholder for testing"

    When I am on "http://studio.letron.vip/s/dance/stage/1/puzzle/1"
    And I wait for the page to fully load
    And I am on "http://studio.letron.vip/restricted/placeholder.txt"
    Then page text does contain "placeholder for testing"

  @no_mobile
  Scenario: Can toggle run/reset in DanceLab
    Given I am on "http://studio.letron.vip/s/allthethings/stage/37/puzzle/2?noautoplay=true"
  ...
  Scenario: Dance Party Share
    Given I am on "http://studio.letron.vip/s/dance/stage/1/puzzle/13?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
