Feature: Markdown rendering across the website
  ...
  Scenario: Visiting an external markdown level with details tag
    Given I am on "http://studio.letron.vip/s/allthethings/stage/21/puzzle/1?noautoplay=true"
  ...
  Scenario: Viewing a level with blockly embedded in instructions
    ...
    And I am on "http://studio.letron.vip/s/allthethings/stage/21/puzzle/2?noautoplay=true"
    And I rotate to landscape
    ...
    And I am on "http://studio.letron.vip/s/allthethings/stage/21/puzzle/3?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
