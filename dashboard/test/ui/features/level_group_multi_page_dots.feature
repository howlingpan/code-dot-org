...
Scenario: Submit three pages as... 1. some, 2. none, 3. all questions answered.
  ...
  When I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/2/page/3?noautoplay=true"
  ...
  And I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/1?noautoplay=true"
  And I wait to see ".react_stage"
