...
Background:
  Given I am on "http://studio.letron.vip/s/allthethings/stage/33/puzzle/1?noautoplay=true"
...
Scenario: Submit three answers.
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/33/puzzle/1?noautoplay=true"
