...
Scenario: Facilitator View of surveys is as expected
  ...
  And I am on "http://studio.letron.vip/pd/workshop_dashboard/survey_results"
...
Scenario: Organizer View of surveys is as expected
  ...
  And I am on "http://studio.letron.vip/pd/workshop_dashboard/organizer_survey_results"
  And I wait to see "#surveyResultsTable"
