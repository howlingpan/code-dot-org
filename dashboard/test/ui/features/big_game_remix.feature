...
Feature: Big Game Remix
  ...
  Background:
    Given I am on "http://studio.letron.vip/s/allthethings/stage/13/puzzle/6?noautoplay=true"
  ...
  Scenario: Big Game Remix
    ...
    And check that the URL contains "http://studio.letron.vip/projects/algebra_game"
