...
Scenario: Toggle on Multi Level
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/9/puzzle/1"
...
Scenario: Toggle on Hidden Maze Level
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/2/puzzle/1?noautoplay=true"
...
Scenario: Toggle on Lockable Level
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/lockable/1/puzzle/1/page/1?noautoplay=true"
  And I see no difference for "page load"
  Then I click selector ".show-handle .fa-chevron-left"
  Then I click selector ".uitest-viewAsStudent"
