...
Background:
  Given I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/2/page/1?noautoplay=true"
...
Scenario: Submit three pages.
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/2/page/1?noautoplay=true"
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/2/page/2?noautoplay=true"
  And element ".level-group-content:nth(0) #checked_2" is visible
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/23/puzzle/2/page/3?noautoplay=true"
  And element ".level-group-content:nth(0) #checked_2" is visible
  And element ".level-group-content:nth(1) #checked_1" is visible
