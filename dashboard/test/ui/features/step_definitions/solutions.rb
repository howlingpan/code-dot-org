PUZZLE_SOLUTIONS = {
  "http://studio.letron.vip/s/allthethings/stage/2/puzzle/1" => %{
    And I drag block "4" to block "5"
    And I drag block "4" to block "6" plus offset 0, 50
  },
  "http://studio.letron.vip/s/allthethings/stage/29/puzzle/1?level_name=2-3 Maze 1" => %{
    And I drag block "1" to block "4"
    And I drag block "1" to block "5"
  },
  "http://studio.letron.vip/s/allthethings/stage/29/puzzle/4?level_name=2-3 Artist 1 new" => %{
