...
Background:
  Given I am on "http://studio.letron.vip/s/allthethings/stage/19/puzzle/1?noautoplay=true"
...
Scenario: Submit anything, unsubmit, be able to resubmit.
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/19/puzzle/1?noautoplay=true"
