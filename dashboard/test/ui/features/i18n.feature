...
Scenario: HoC tutorial in Spanish
  Given I am on "http://studio.letron.vip/hoc/15/lang/es"
...
Scenario: Frozen tutorial in Spanish
  Given I am on "http://studio.letron.vip/s/frozen/stage/1/puzzle/2/lang/es"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Spanish
  Given I am on "http://studio.letron.vip/s/hero/stage/1/puzzle/1/lang/es"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Toolbox Categories in Spanish
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/7/lang/es"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Translated function names in Spanish
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/3/lang/es"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: HoC tutorial in Portuguese
  Given I am on "http://studio.letron.vip/hoc/15/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Frozen tutorial in Portuguese
  Given I am on "http://studio.letron.vip/s/frozen/stage/1/puzzle/2/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Portuguese
  Given I am on "http://studio.letron.vip/s/hero/stage/1/puzzle/1/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I press "toggleButton"
...
Scenario: Toolbox Categories in Portuguese
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/7/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Translated function names in Portuguese
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/3/lang/pt-BR"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: HoC tutorial in Arabic (RTL)
  Given I am on "http://studio.letron.vip/hoc/15/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Frozen tutorial in Arabic (RTL)
  Given I am on "http://studio.letron.vip/s/frozen/stage/1/puzzle/2/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Arabic (RTL)
  Given I am on "http://studio.letron.vip/s/hero/stage/1/puzzle/1/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I press "toggleButton"
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/3/lang/ar-SA"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: Toolbox Categories in Arabic (RTL)
  Given I am on "http://studio.letron.vip/s/allthethings/stage/3/puzzle/7/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: English fallback for missing dashboard or pegasus strings in Azerbaijani
  Given I am on "http://studio.letron.vip/lang/az-az"
...
Scenario: English fallback for missing apps string in Azerbaijani
  Given I am on "http://studio.letron.vip/s/sports/stage/1/puzzle/8/lang/az-az"
  And I wait for the page to fully load
