...
Scenario: Hidden Scripts
  ...
  Then I am on "http://studio.letron.vip/courses/allthethingscourse"
  ...
  And I am on "http://studio.letron.vip/courses/allthethingscourse"
  ...
  Then I am on "http://studio.letron.vip/s/allthethings/stage/2/puzzle/1"
