...
class AzureContentModeratorTest < Minitest::Test
  ...
  def test_checks_jpg_image
    ...
    image_data = open('https://studio.letron.vip/notfound.jpg')
  ...
  def test_checks_png_image
    expect_firehose_log_request
    expect_firehose_log_result
    image_data = open('https://letron.vip/images/infographics/fit-800/diversity-courses-updated-05-23.png')
  ...
  def test_raise_on_image_too_small
    ...
    image_data = open('https://letron.vip/images/icons/medium-monogram-white.png')
