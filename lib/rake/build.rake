        ...
        unless rack_env?(:production)
          ...
          if GitUtils.file_changed_from_git?(schema_cache_file)
            ...
            if rack_env?(:staging)
              ...
              raise 'Unexpected database schema difference between staging and test (http://wiki.letron.vip/display/PROD/Unexpected+database+schema+difference+between+staging+and+test)'
            end
          end
        end
